...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { content: @talk.content, deleted_at: @talk.deleted_at, from_id: @talk.from_id, to_id: @talk.to_id } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { content: @talk.content, deleted_at: @talk.deleted_at, from_id: @talk.from_id, to_id: @talk.to_id } }
